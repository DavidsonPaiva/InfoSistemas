...
function TfrmCadCliente.SoNumeros(Const Texto: String): String;
begin
  var
  Aux := string.Empty;
...
class function TMyFieldsHelper.Parse(_iField: String): TMyFields;
begin
  Result := TMyFields(AnsiIndexStr(_iField, MyArrayFields));
end;

class function TMyFieldsHelper.Parse(_iField: Integer): TMyFields;
begin
